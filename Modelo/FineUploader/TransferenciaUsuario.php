...
if ($method == "POST") {
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks("../../SubidArchivos/archivos/transferenciaUsuario");
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload("../../SubidArchivos/archivos/transferenciaUsuario");
...
// for delete file requests
    ...
    $result = $uploader->handleDelete("../../SubidArchivos/archivos/transferenciaUsuario");
    echo json_encode($result);
}
else {
