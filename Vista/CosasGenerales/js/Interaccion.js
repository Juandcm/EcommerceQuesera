...
function tablacarritodecompras(){
    $("#tablacarritodecompras").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/carritoControler.php?op=mostrarProductosCarritosFull',
            type: "post",
            dataType: "json",
            beforeSend: function () {
...
function tablaprocesarcompras() {
    $("#tablaprocesarcompras").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/procesarcompraControler.php?op=mostrartodascompras',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function tablamensajeusuario0() {
    $("#tablamensajeusuario0").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/mensajeControler.php?op=mensajeusuario0',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function tablamensajeusuario1() {
    $("#tablamensajeusuario1").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/mensajeControler.php?op=mensajeusuario1',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function tablamensajeadmin0() {
    $("#tablamensajeadmin0").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/mensajeControler.php?op=mensajeusuarioadmin0',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function tablamensajeadmin1() {
    $("#tablamensajeadmin1").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/mensajeControler.php?op=mensajeusuarioadmin1',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function tablacomprastienda() {
    $("#tablacomprastienda").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/procesarcompraControler.php?op=mostrartodascomprasusuarios',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function tablabancos() {
    $("#tablabancos").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/bancoControler.php?op=mostrarbancoadmin',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function productosen1() {
    $("#productosen1").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/productoControler.php?op=listarSoloEstado1',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function productosen0() {
     $("#productosen0").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/productoControler.php?op=listarSoloEstado0',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function tipoproductos() {
    $("#tabalatipoproducto").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/productoControler.php?op=tipoproductos',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function usuariosen1() {
    $("#usuariosen1").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/usuarioControler.php?op=usuariosen1',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
function usuariosen0() {
    $("#usuariosen0").dataTable({
        ...
        "bPaginate": true,
        "ajax": {
            url: '/Controlador/usuarioControler.php?op=usuariosen0',
            type: "post",
            dataType: "json",
            beforeSend: function () {
                $(".cuerpo").css('filter', 'blur(2px)');
...
$('#userregisterModalForm').on('submit', function (e) {
    ...
    $.post('/Controlador/usuarioControler.php?op=registrar', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
...
$('#enviarmensjaeModalForm').on('submit', function (e) {
    ...
    $.post('/Controlador/mensajeControler.php?op=enviarmensaje', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
$('#reenviarcontrasenaForm').on('submit', function (e) {
    ...
    $.post('/Controlador/usuarioControler.php?op=reenviarcontrasena', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
function agregarProductoCarrito(idproducto, precioproducto, valorboton) {
    ...
    $.post('/Controlador/carritoControler.php?op=addToCart', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
function eliminarproductocarrito(idproducto) {
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            ...
            $.post('/Controlador/carritoControler.php?op=removeCartItem', { 'rowid': idproducto }, function (data) {
            }).done(function (data) {
                // console.log(data);
                datos = JSON.parse(data);
                valorestado = datos.estado.type;
...
function updateCartItem(id, cantidad) {
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            ...
            $.post('/Controlador/carritoControler.php?op=actualizarCarrito', { 'id': id, 'qty': cantidad.value }, function (data) {
            }).done(function (data) {
                // console.log(data);
                datos = JSON.parse(data);
                valorestado = datos.estado.type;
...
$("#botoncomprar").on('click', function (e) {
    e.preventDefault();
    $.post('/Controlador/carritoControler.php?op=placeOrder', {}, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
function detallescompra(idcompra) {
    ...
    $.post("/Controlador/procesarcompraControler.php?op=detallescompra", {
        "idcompra": idcompra
...
function detallescomprausuarios(idcompra) {
    // console.log(idcompra)
    $.post("/Controlador/procesarcompraControler.php?op=detallescomprausuarios", {
        "idcompra": idcompra
    }, function () { }).done(function (data) {
        // console.log(data)
...
function eliminarproductocompra(car_id){
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/procesarcompraControler.php?op=eliminarproductocompra", {
                "car_id": car_id
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
function eliminarcompra(idcompra) {
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/procesarcompraControler.php?op=cancelarcompra", {
                "idcompra": idcompra
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
$('#userlostpasswordModalForm').on('submit', function (e) {
    ...
    $.post('/Controlador/usuarioControler.php?op=enviarcorreo', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
...
$('#userloginModalForm').on('submit', function (e) {
    ...
    $.post('/Controlador/usuarioControler.php?op=entrar', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
$('#usereditarModalForm').on('submit', function (e) {
    ...
    $.post('/Controlador/usuarioControler.php?op=editarUsuario', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
$('#tipoproductoForm').on('submit', function (e) {
    ...
    $.post('/Controlador/productoControler.php?op=crearTipoProducto', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
$('#crearproductoForm').on('submit', function (e) {
    ...
    $.post('/Controlador/productoControler.php?op=crearProducto', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
$('#editartipoproductoForm').on('submit', function (e) {
    ...
    $.post('/Controlador/productoControler.php?op=editartipoProducto', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
$('#editarproductoForm').on('submit', function (e) {
    ...
    $.post('/Controlador/productoControler.php?op=editarProducto', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
$(".salirsession").on('click', function (event) {
    ...
    $.post("/Controlador/usuarioControler.php?op=salir", {}, function () { }).done(function () {
        $('body').html("<div class='preloader'><div class='cssload-speeding-wheel'></div></div>");
...
function mostrartipoproducto() {
    $.post('/Controlador/productoControler.php?op=mostrartipoproducto', {}, function (data) {
...
function mostrarproductofront(buscar) {
    ...
    $.post('/Controlador/productoControler.php?op=mostrarproductofront', valores, function (data) {
        /*optional stuff to do after success */
    }).done(function (data) {
...
function mostrarDetallesProducto(idproducto, vista) {
    ...
    $.post('/Controlador/productoControler.php?op=mostrarDetallesProducto', { 'idproducto': idproducto, 'vista': vista }, function (data) {
        /*optional stuff to do after success */
    }).done(function (data) {
...
function eliminarTipoProducto(idtipo) {
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/productoControler.php?op=eliminartipo", {
                "idtipo": idtipo
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
function eliminarProducto(idproducto) {
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/productoControler.php?op=eliminarproducto", {
...
function desaprobar(idproducto) {
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/productoControler.php?op=desactivarproducto", {
                "idproducto": idproducto
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
function aprobar(idproducto) {
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/productoControler.php?op=aprobarproducto", {
                "idproducto": idproducto
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
$('#crearbancoForm').on('submit', function (e) {
    ...
    $.post('/Controlador/bancoControler.php?op=procesarbanco', formulario, function (data) {
    }).done(function (data) {
        // console.log(data);
        datos = JSON.parse(data);
        valorestado = datos.estado.type;
...
$("#editarbancoForm").on('submit', function(e){
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/bancoControler.php?op=editarbanco", formulario, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
                valorestado = datos.estado.type;
                valormsg = datos.estado.msg;
...
$("#procesarpagoForm").on('submit', function(e){
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/procesarcompraControler.php?op=completarpago", formulario, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
                valorestado = datos.estado.type;
                valormsg = datos.estado.msg;
...
function mostrarbancoselect(){
    $.post('/Controlador/procesarcompraControler.php?op=revisarbanco', {}, function(data) {
        /*optional stuff to do after success */
    }).done(function(data){
...
$("#selectbanco").change(function(){
    ...
    $.post('/Controlador/procesarcompraControler.php?op=mostrarbancousuario', {'selectbanco':selectbanco}, function(data) {
        /*optional stuff to do after success */
    }).done(function(data){
    //   console.log(data)
        datos = JSON.parse(data);
...
function eliminarbanco(ban_id){
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/bancoControler.php?op=eliminarbanco", {
                "ban_id": ban_id
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
function eliminarcomprobante(com_id){
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/procesarcompraControler.php?op=eliminarcomprobante", {
                "com_id": com_id
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
function mostrarestadisticas(){
    $.post("/Controlador/estadisticaControler.php?op=mostrartodo", {}, function () { }).done(function (data) {
    // console.log(data)
    datos = JSON.parse(data);
    valorestado = datos.estado.type;
...
function rechazarcompra(com_id){
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/procesarcompraControler.php?op=rechazarcompra", {
                "com_id": com_id
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
function aprobarcompra(com_id){
    ...
    swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/procesarcompraControler.php?op=aprobarcompra", {
                "com_id": com_id
            }, function () { }).done(function (data) {
                console.log(data)
                datos = JSON.parse(data);
...
console.log(usu_id)
 swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/usuarioControler.php?op=desactivarusuario", {
                "usu_id": usu_id
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
console.log(usu_id)
 swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/usuarioControler.php?op=activarusuario", {
                "usu_id": usu_id
            }, function () { }).done(function (data) {
                // console.log(data)
                datos = JSON.parse(data);
...
swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/usuarioControler.php?op=eliminarusuario", {
                "usu_id": usu_id
            }, function () { }).done(function (data) {
                console.log(data)
                // datos = JSON.parse(data);
...
function detallesmensaje(men_id){
    // console.log(men_id)
    $.post("/Controlador/mensajeControler.php?op=detallesmensajeusuario", {'men_id':men_id}, function () { }).done(function (data) {
        // console.log(data)
...
$("#botonotificacion").on('click',function(e){
    e.preventDefault();
    $.post("/Controlador/mensajeControler.php?op=cargarNotificaciones", {}, function () { }).done(function (data) {
        // console.log(data)
...
function cantidadnotificacion(){
    $.post("/Controlador/mensajeControler.php?op=mostrarCantidadNotificaciones", {}, function () { }).done(function (data) {
        // console.log(data)
...
$("#botonotificacionusuario").on('click',function(e){
    e.preventDefault();
    $.post("/Controlador/mensajeControler.php?op=cargarNotificacionesUsuario", {}, function () { }).done(function (data) {
        // console.log(data)
...
function cantidadnotificacionUsuario(){
    $.post("/Controlador/mensajeControler.php?op=mostrarCantidadNotificacionesUsuario", {}, function () { }).done(function (data) {
        // console.log(data)
...
swalWithBootstrapButtons({
        ...
        if (result.value) {
            $.post("/Controlador/redsocialControler.php?op=subirTumblr", datos, function () { }).done(function (data) {
                console.log(data)
