(function($){
  ...
  $(function() {
    ...
    jQuery(document).on('click', '.plus', function(e) {
      ...
      newValue = parseInt(quantityInput.val(), 10) + 5,
      ...
      $("#displaytotal").css('display','block')
      $("#preciosubtotal").html($("#pro_precio").val()*newValue +" Bs")

    });

    jQuery(document).on('click', '.plus', function(e) {
      e.preventDefault();
      var quantityInput = jQuery(this).parents('.quantity').find('input.qty2'),
      newValue = parseInt(quantityInput.val(), 10) + 5,
      maxValue = parseInt(quantityInput.attr('max'), 10);
...
if (newValue===0) {
      $("#displaytotal").css('display','none')
      }else{
      $("#displaytotal").css('display','block')
      $("#preciosubtotal").html(parseInt($("#pro_precio").val()*newValue, 10) +" Bs")
      }
    });
  ...
  $('a[href="#footerpagina"]').on('click',function(){
    $('html, body').animate({scrollTop:$(document).height()}, 1000, "easeInOutQuint");
    return false;
  });
